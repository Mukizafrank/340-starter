...
ALTER TABLE IF EXISTS public.user_favorites
  ADD CONSTRAINT uq_user_inv UNIQUE (account_id, inv_id);

-- Foreign keys to account and inventory
ALTER TABLE IF EXISTS public.user_favorites
  ADD CONSTRAINT fk_fav_account FOREIGN KEY (account_id)
  REFERENCES public.account (account_id) MATCH SIMPLE
  ON UPDATE CASCADE
  ON DELETE CASCADE;

ALTER TABLE IF EXISTS public.user_favorites
  ADD CONSTRAINT fk_fav_inventory FOREIGN KEY (inv_id)
